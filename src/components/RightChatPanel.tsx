  ...
  useEffect(() => {
    if (externalMessage && isOpen) {
      const timer = setTimeout(async () => {
        ...
        await speakWithIndicator(externalMessage); // NEW
        await speakWithIndicator("You can talk to or you can type text here.");
  ...
  const handleSend = async (overrideValue?: string) => {
    ...
    setTimeout(async () => {
      ...
      if (query.includes("onboard") || query.includes("onboarding")) {
        responseText =
          "Got it. You want to know how to create a new customer or organization.";
      ...
      setIsTyping(false);
      speakWithIndicator(responseText);
    }, 1000);
  };
